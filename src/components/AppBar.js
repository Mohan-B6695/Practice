      ...
      <div>
        <AppBar position="static" className={classes.appBar}>
          ...
          <Grid container className={classes.gridDiv}>
            ...
            <IconButton arial-lable="profile" className="account"  onClick={(this.handleChange)}>
              <AccountCircleIcon className={classes.accountIcon} /><Typography style={{
                        fontSize: "medium",
                        display:"inline",marginTop:"5%",marginLeft:"10%"
